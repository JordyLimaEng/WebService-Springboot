...
public class Order implements Serializable {
	...
	@OneToMany(mappedBy = "id.order")// pega o id do orderitem para pegar o pedido
	private Set<OrderItem> items = new HashSet<>();
	
	@OneToOne(mappedBy = "order", cascade = CascadeType.ALL)//como é um para um, mapea-se as duas entidades para ter o mesmo id, para isso usa-se o cacade...
